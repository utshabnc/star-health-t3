...
conditions_topic = root.find('.//topic[@id="Conditions"]')
...
with open(csv_filename, "r") as csv_file:
    ...
    cursor.copy_expert('COPY "Diseases" (NAME,url) FROM STDIN WITH CSV', csv_file)
# Cleanup
cursor.close()
conn.close()
os.remove(csv_filename)

print("Data has been bulk imported into the PostgreSQL table 'Diseases'.")
# Print the JSON data
# if data:
