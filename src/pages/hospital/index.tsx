...
const HospitalDetails = () => {
  ...
  const hospitalDataTemplate = [
    ...
    },
    {
      ...
      description: "Community health improvement services and community benefit operations"
    },
    {
      code: "hlth_prof_educ",
    ...
    },
    {
      ...
      description: "Leadership development and training for community members"
    },
    {
    ...
    },
    {
      ...
      description: "Physical improvements and housing percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_econdevlp_pct",
      description: "Economic development percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_cmntysuprt_pct",
      description: "Community support percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_envrnimprv_pct",
      description: "Environmental improvements percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_ldrdevlp_pct",
      description: "Leadership development and training for community members percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_cltnbldg_pct",
      description: "Coalition building percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_htlhimprvadvcy_pct",
      description: "Community health improvement advocacy percentage of community building activities"
    },
    {
      code: "comm_bldg_actvs_wrkfrcdevlp_pct",
      description: "Workforce development percentage of community building activities"
    },
    {
    ...
    },
    {
      ...
      description: "Bad debt, attributable to patients eligible for financial assistance"
    },
    {
      code: "mdcre_shrtfl",
    ...
    },
    {
      ...
      description: "Total community benefits as % of total functional expenses"
    },
    {
    ...
    },
    {
      ...
      description: "Community health improvement services and community benefit operations as % of total functional expenses"
    },
    {
      code: "hlth_prof_educ_tot_func_exp_pct",
      description: "Health professions education as % of total functional expenses"
    },
    {
      code: "subsd_hlth_svcs_tot_func_exp_pct",
      description: "Subsidized health services as % of total functional expenses"
    },
    {
    ...
    },
    {
      ...
      description: "Cash and in-kind contributions to community groups as % of total functional expenses"
    },
    {
    ...
    },
    {
      ...
      description: "Community building activities as % of total functional expenses"
    },
    {
    ...
    },
    {
      ...
      description: "Bad debt as % of total functional expenses, attributable to patients eligible for financial assistance"
    },
    {
      code: "mdcre_shrtfl_tot_func_exp_pct",
      description: "Medicare Shortfall as % of total functional expenses (negative value indicates surplus)"
    },
    {
      code: "rat_pat_care_npat_care_comm_bnfts",
      description: "Ratio of Patient Care to Non-patient Care Community Benefits"
    },
    {
    ...
    },
    {
      ...
      description: "Used federal poverty guidelines to determine eligibility for free or discounted care"
    },
    {
    ...
    },
    {
      ...
      description: "CHNA took into account input from persons who represent broad interests of the community served"
    },
    {
    ...
    },
    {
      ...
      description: "Hospital adopted implementation strategy to address health needs of community"
    },
    {
      code: "hosp_exe_imp_stg_addr_hlth_needs_comm_f",
      description: "Hospital executed implementation strategy addressing health needs of community"
    },
    {
      code: "hosp_prtcp_dev_commwide_comm_bnft_plan_f",
      description: "Hospital participated in development of community-wide community benefit plan"
    },
    {
    ...
    },
    {
      ...
      description: "Quartile of percent persons <65 years old without health insurance"
    },
    {
    ...
    },
    {
      ...
      description: "State implemented ACA Medicaid expansion covering adults with incomes up to 138% FPL"
    },
    {
      code: "st_inc_elig_prnts_dep_chldrn_enrol_medcd_ltd_76pct_fpl_less_f",
      description: "State income eligibility for parents of dependent children enrolling in Medicaid limited to 76% FPL or less"
    },
    {
      code: "st_law_req_hosp_rpt_comm_bnfts_f",
      description: "State law requiring hospital to report community benefits"
    },
    {
      code: "updated_dt",
  ...
  const hospitalContent = (data: HospitalData): JSX.Element => {
    return <div>
      {hospitalDataTemplate.map((dataTemplate, index) => {
        return <p key={index}><span className="text-bold">{dataTemplate.description}: </span>{data[dataTemplate.code]}</p>
      })}
    </div>
  }
