		...
		<>
				...
				<div className='container flex max-w-[1140px] my-0 mx-auto w-[100%] pb-[50px] justify-center'>
					<div className='p-[25px] mx-4 leading-tight border border-[#d0d0d0] text-center relative md:mb-8 '>
						...
						<p className='font-medium mb-[157.8px]'>Access firmographic data to learn more about companies at no cost</p>
					...
					<div className='p-[25px] mx-4 leading-tight border border-[#d0d0d0] text-center relative md:mb-8 '>
						...
						<h5 className='py-4 mb-2 font-bold text-[22px] '>$29</h5>
						<p className='font-medium mb-[20px] '>/ user / month, billed annually</p>
						<p className='font-medium mb-[20px] '>Track and monitor the companies you care about</p>
					...
					<div className='p-[25px] mx-4 leading-tight border border-[#d0d0d0] text-center relative md:mb-8 '>
						...
						<h5 className='py-4 mb-2 font-bold text-[22px] '>$49</h5>
						<p className='font-medium mb-[20px] '>/ user / month, billed annually</p>
						<p className='font-medium mb-[20px] '>Unlock StarHealth&apos;s full suite of prospecting tools fueled by sales intelligence</p>
				...
				<div className='container text-[16px] leading-relaxed flex max-w-[1190px] my-0 mx-auto w-[100%] pb-[50px] justify-center '>
					<div className='self-center font-medium break-words'>
						<h2 className='mb-3 leading-tight text-[36px]'>Interested in Licensing StarHealth Data? </h2>
						...
						<div className='flex justify-end mb-8 max-w-4xl'>
							<div className='box-border mx-7 basis-1/4 grow-0 break-words'>
								<div className=''>
									...
									<h2 className='font-bold text-[19px] text-center w-[165px] leading-none ml-5'>$29 / user / month billed annually </h2>
							...
							<div className='mx-7 basis-1/4 grow-0 break-words'>
								<div className='box-border'>
									...
									<h2 className='font-bold text-[19px] text-center w-[165px] leading-none ml-5'>$49 / user / month billed annually </h2>
									<div className='mt-5 flex flex-wrap items-center '>
										<div className='inline-block m-0'>
											<a className='flex bg-[#8D47FC] text-white font-medium items-center justify-center uppercase rounded-[10px] h-[48px] w-[210px]'>
												<BsLightningFill className='mt-[3px] mr-[3px]'/>
							...
							<div className='mx-7 basis-1/4 grow-0 break-words'>
								<div className='box-border'>
									...
									<h2 className='font-bold text-[19px] text-center w-[165px] leading-none pt-[18px] ml-5'>Custom</h2>
