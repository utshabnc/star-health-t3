                ...
                <div className="w-full md:w-1/2 px-3">
                    <div className="col">
                        <label htmlFor="email" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Email</label>
                            ...
                            />
                        {errors.email && (
                            <p className="text-red-500 pb-2 text-small">{`${errors.email.message}`}</p>
                        )}
                    </div>
                </div>
                <div className="w-full md:w-1/2 px-3">
                <div className="col">
                    <label htmlFor="hashedPassword" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                        Password
                    </label>
                    <input
                    ...
                    <p className="text-red-500 pb-2 text-small">{`${errors.hashedPassword.message}`}</p>
                    )}
                </div>
                </div>
                {/**<div className="w-full md:w-1/2 px-3">
                    <InputField label="Confirm Password" name="confirmPassword" placeholder="********" type="password" value={formData.confirmPassword} onChange={handleChange} />
                </div>**/}
                <div className="w-full md:w-1/2 px-3">
                    <div className="col">
