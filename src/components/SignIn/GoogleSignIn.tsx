...
const GoogleSignInButton = () => {
  ...
  return (
    ...
    className="flex items-center justify-center bg-blue-600 text-white rounded-md py-2 px-4 md:py-3 md:px-6 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
    >
    <svg
    ...
    <span className="hidden md:block ">Sign Up with Google</span>
  </button>
  );
};
const GoogleLogo = () => (
