...
const SignIn = () => {
  ...
  const [emailSignUp, setEmailSignUp] = useState<Record<string , string>>({
    customFirstName : '',
    customLastName : '',
    customEmail : '',
    customPassword : '',
   ...
   const handleEmailSubmitForm = async (e : FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/register/register', {
        ...
        body : JSON.stringify({
          firstName : emailSignUp.customFirstName,
          lastName : emailSignUp.customLastName,
          email : emailSignUp.customEmail,
          password : emailSignUp.customPassword,
          confirmPassword : emailSignUp.customConfirmPassword 
        })
      })
      if(!response.ok) {
  ...
  const handleMainPrevious = () => {
    ...
    if (router.pathname === '/directory?login=true') {
    ...
    return (
      ...
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 shadow-lg rounded-lg border">
        ...
        {session?.user && !session?.user?.isRegistered && (<>
            ...
            <ol className="flex items-center p-4 text-sm font-medium text-center justify-center text-white-500 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 sm:text-base white:bg-gray-800 white:border-gray-700">
              ...
              {activeSection === 1 && (
                <li className="flex items-center justify-center text-purple-600 dark:text-purple-500 text-center">
                  ...
                  Professional <span className="hidden sm:inline-flex sm:ml-2">Info</span>
                  <svg className="w-3 h-3 ml-2 sm:ml-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 10">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m7 9 4-4-4-4M1 9l4-4-4-4"/>
                  </svg>
                </li>
        ...
        {!session?.user && currentStep === 0 && !login && (
          <>
            <div className="mt-2 flex items-center justify-center px-24">
              <div>
                <h1 className="text-4xl text-center mb-16 font-custom">
        ...
        {currentStep === 1 && (
          ...
          <div className="absolute top-0 left-0 w-full h-full backdrop-blur-sm flex justify-center items-start">
            ...
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 shadow-lg rounded-lg border p-">
              ...
              <button className="font-bold py-2 px-4 flex-start" onClick={() => setCurrentStep(0)}>
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-arrow-left-circle text-purple-500" viewBox="0 0 16 16">
                ...
                <div>
                  {!isEmailSent ? (
                    <>
                      ...
                      {emailSignUp.message && <p className={`text-${registerErrors ? 'red' : 'green'}-500 pb-2`}>{emailSignUp.message}</p>}
                    ...
                    <div className="w-1/3 md:w-1/2 px-3 mb-6 md:mb-0">
                      <div className="col">
                            ...
                            <input
                                ...
                                placeholder="John"
                                value={emailSignUp.customFirstName}
                      ...
                      <div className="w-1/3 md:w-1/2 px-3 mb-6">
                        <div className="col">
                            ...
                            <input
                                ...
                                name="customLastName"
                                placeholder="Doe"
                                value={emailSignUp.customLastName}
                      ...
                      <div className="w-1/3 md:w-1/2 px-3">
                        <div className="col">
                            ...
                            <input
                                ...
                                name="customPassword"
                                placeholder="********"
                                value={emailSignUp.customPassword}
                      ...
                      <div className="w-1/3 md:w-1/2 px-3">
                        <div className="col mt-5">
                            <label htmlFor="password" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Confirm Password</label>
                            <input
                                type="password"
                                name="customConfirmPassword"
                                placeholder="********"
                                value={emailSignUp.customConfirmPassword}
                                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-indigo-500/75 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-password"
                                onChange={handleChange}
                            />
                        </div>
                    ...
                    <div>
                      ...
                      <p className="text-1xl">
                        We sent an email to {emailSignUp.customEmail}<br />
        ...
        {((login && !session?.user && currentStep === 0 ) || (!session?.user && currentStep === 2)) && (
          <>
          <div className="absolute top-0 left-0 w-full h-full backdrop-blur-sm flex justify-center items-start">
            {/* Log in block */}
            ...
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 shadow-lg rounded-lg border p-">
              ...
              <button className="font-bold py-2 px-4 flex-start" onClick={handleMainPrevious}>
                    <span>
                       <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-arrow-left-circle text-purple-500" viewBox="0 0 16 16">
                          <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
                        </svg>
